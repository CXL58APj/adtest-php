                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="update.php?id=<?php echo htmlentities($result->id);?>" class="btn btn-primary btn-sm"><span class="uil-edit"></span></a>
                                                            <a href="index.php?del=<?php echo htmlentities($result->id);?>" class="btn btn-danger btn-sm" onClick="return confirm('Do you really want to delete?')"><span class="uil-trash-alt"></span></a>
                                                        </td>
                                                    </tr>
                                                <?php 
                                                    $cnt++;
